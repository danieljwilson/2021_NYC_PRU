...
path_open_data = '/Users/djw/Documents/pCloud_synced/Academics/Projects/2021_NYC_PRU/Data/open_data/'
...
for (year in open_years){
  ...
  df_open = read_csv(paste0(path_open_data, open_file_list[index]))
  ...
  if (any(str_detect(full_file_list, as.character(year)))){
    ...
    # load in each individual year
    df_full = read_csv(paste0(path_full, full_file_list[index]))
