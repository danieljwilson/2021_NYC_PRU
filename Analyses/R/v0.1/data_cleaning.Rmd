...
file_list <- list.files(path = path, pattern = '\\.csv', ignore.case = TRUE)
```
...
1. take a small subset of the original dataframes according to the information we will present.
    - [This](https://docs.google.com/spreadsheets/d/1ndZtYpCjD4CCIyGU2chJjw6yMPr4PDQY6q8OJeoYpso/edit?usp=sharing) is a file that lists the column *Names* and *Descriptions*, along with coding information.
